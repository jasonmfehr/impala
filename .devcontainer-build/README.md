...
If there is an issue with the `stable` image, and a backout is neccesary, run: `OCI_SRC_TAG=stable-prev OCI_DEST_TAG=stable ./.devcontainer-build/tag-multiplatform-manifest.sh`
