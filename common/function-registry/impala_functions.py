...
visible_functions = [
  ...
  [['parse_url'], 'STRING', ['STRING', 'STRING', 'STRING'], 'impala::StringFunctions::ParseUrlKey',
   '_ZN6impala15StringFunctions15ParseUrlPrepareEPN10impala_udf15FunctionContextENS2_18FunctionStateScopeE',
   '_ZN6impala15StringFunctions13ParseUrlCloseEPN10impala_udf15FunctionContextENS2_18FunctionStateScopeE'],
   [['prettyprint_duration'], 'STRING', ['BIGINT', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['INT', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['SMALLINT', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['TINYINT', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['FLOAT', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['DOUBLE', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
   [['prettyprint_duration'], 'STRING', ['DECIMAL', 'STRING'], 'impala::StringFunctions::PrettyPrintDuration'],
