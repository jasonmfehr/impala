...
void TimedSpan::SetAttribute(string key, const common::AttributeValue& value) noexcept {
  span_->SetAttribute(key, value);
} // function SetAttribute

void TimedSpan::AddEvent(std::string name, OtelAttributesMap additional_attributes)
    noexcept {
  span_->AddEvent(name, additional_attributes);
} // function AddEvent

trace::Scope TimedSpan::SetActive() {
  return tracer_->WithActiveSpan(span_);
} // function SetActive
