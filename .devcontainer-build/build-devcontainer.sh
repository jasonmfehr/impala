...
#   OCI_IMG:        The name of the OCI image to build. Default: "apache/impaladev"
...
#   IMPALA_DOCKER_BUILDER: The name of the docker buildx builder to create/use.
...
# Load Impala environment variables to discover the toolchain packages directory.
SKIP_JAVA_DETECTION=1 . bin/impala-config.sh
