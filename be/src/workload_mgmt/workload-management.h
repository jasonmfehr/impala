...
/// These checks ensure the provided value for the --workload_mgmt_schema_version startup
/// flag is a valid, known schema version.
///
/// The flag is parsed into a kudu::Version and returned via the `target_schema_version`
/// output parameter.
