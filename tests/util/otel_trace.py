...
class AttributeValue:
  """
    ...
    the attribute value. Additionaly, the class function get_type() returns the attribute
    value's type.
  """
...
class OtelSpan:
  """
    ...
    Attributes:
      ...
      query_id: The query ID associated with this span. This value is extraced from the
...
def parse_trace_file(file_path, query_id):
  ...
  assert query_trace is not None, "Could not find trace for query: {}".format(query_id)
